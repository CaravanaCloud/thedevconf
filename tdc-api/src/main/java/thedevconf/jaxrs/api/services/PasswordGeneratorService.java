...
public class PasswordGeneratorService {
    ...
    public static final String ITERATION_COUNT_PROPERTY =
            "thedevconf.jaxrs.api.services.PasswordGeneratorService.PBEKeySpec.iterationCount";
    ...
    public static final String KEY_LENGTH_PROPERTY =
            "thedevconf.jaxrs.api.services.PasswordGeneratorService.PBEKeySpec.keyLength";
    ...
    public static final String SECRET_KEY_ALGORITHM_PROPERTY =
            "thedevconf.jaxrs.api.services.PasswordGeneratorService.SecretKeyFactory.algorithm";
